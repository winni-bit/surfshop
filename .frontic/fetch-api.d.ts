...
export interface paths {
  ...
  "/listing/heroproducts": {
    /**
     * Fetch HeroProducts
     * @description Fetch HeroProducts
     */
    post: operations["getHeroProductsBlock"];
    parameters: {
      header?: {
        "fs-request-url"?: components["parameters"]["FsRequestUrl"];
      };
  ...
  "/block/producthero/{key}": {
    /**
     * Fetch ProductHero
     * @description Fetch ProductHero
     */
    post: operations["getProductHeroBlock"];
    parameters: {
      header?: {
        "fs-request-url"?: components["parameters"]["FsRequestUrl"];
      };
  ...
  "/listing/topcategories": {
    /**
     * Fetch TopCategories
     * @description Fetch TopCategories
     */
    post: operations["getTopCategoriesBlock"];
    parameters: {
      header?: {
        "fs-request-url"?: components["parameters"]["FsRequestUrl"];
      };
...
export interface components {
  schemas: {
    ...
    HeroProducts: {
      items?: components["schemas"]["ProductHero"][];
      filter?: components["schemas"]["_filter"];
      aggregation?: components["schemas"]["_aggregation"];
      sort?: components["schemas"]["_sort"];
      page?: components["schemas"]["_page"];
    ...
    /** @description Available query options (filters and sortings) for HeroProducts blocks */
    HeroProductsQueryOptions: {
      /** @description Sort options for HeroProducts blocks */
      sort: Record<string, never>;
      /** @description Filter options for HeroProducts blocks */
      filter: Record<string, never>;
    };
    /** @description Available query options (filters and sortings) for TopCategories blocks */
    TopCategoriesQueryOptions: {
      /** @description Sort options for TopCategories blocks */
      sort: Record<string, never>;
      /** @description Filter options for TopCategories blocks */
      filter: Record<string, never>;
    };
  ...
  parameters: {
    ...
    FsVersionToken: "a1f9bd58-ae9d-4533-9546-bce82396fe9b";
...
export interface operations {
  ...
  getHeroProductsBlock: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["HeroProducts"];
        };
      };
      /** @description Not Found */
      404: {
  ...
  getProductHeroBlock: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["ProductHero"];
        };
      };
      /** @description Not Found */
      404: {
  ...
  getTopCategoriesBlock: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["TopCategories"];
        };
      };
      /** @description Not Found */
      404: {
